...
function checkObject(obj, depth = 0) {
    ...
    // ⚡ Bolt Optimization: Handle arrays separately with a fast, direct loop.
    // This avoids iterating over array indices as keys via `for...in` and checks elements directly,
    // avoiding redundant `checkValue(key)` validation on array keys like '0', '1'.
