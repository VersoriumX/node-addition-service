...
function checkObject(obj, depth = 0) {
    // 🛡️ Sentinel: Depth limit to prevent stack overflow on circular references
...
function electricFence(req, res, next) {
    ...
    // ⚡ Bolt Optimization: Manual loop within checkObject to avoid Object.values() array allocation and some() overhead.
