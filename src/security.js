...
function checkValue(val) {
    if (typeof val === 'string') {
        ...
        // Detecting 3 non-overlapping '**' pairs requires at least 6 characters. This avoids
        // indexOf string scanning on standard object keys and short parameter values.
