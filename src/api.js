...
async function fetchWithCache(url, cache, headers = {}) {
    ...
    const fetchPromise = (async () => {
        try {
            ...
            // ⚡ Bolt Optimization: Pre-calculate JSON and ETag to avoid redundant work in the API route.
...
// ⚡ Bolt Optimization: Exposed cache accessors for high-performance delivery in index.js
