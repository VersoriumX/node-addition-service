...
/**
 * ⚡ Bolt Optimization:
 * Lazy cache invalidation. Clears cache references on mutations so JSON stringification
 * and MD5 ETag computation are deferred until requested by `getAllTokensJSON()` or `getAllTokensETag()`.
 */
