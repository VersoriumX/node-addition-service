...
/**
 * ⚡ Bolt Optimization: Fast string reversal without intermediate array allocation.
 * Avoiding .split('').reverse().join('') eliminates temporary array creations and reduces GC pressure.
 */
