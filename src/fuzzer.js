...
/**
 * ⚡ Bolt Optimization: Fast string reversal helper.
 * Using a backward loop avoids intermediate character array allocations
 * and array reverse overhead (`str.split('').reverse().join('')`).
 */
...
function generateVariations(baseString) {
    ...
    variations.add(baseString + "!");
    // ⚡ Bolt Optimization: Use fast backward loop for string reversal instead of .split('').reverse().join('')
