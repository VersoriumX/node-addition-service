...
// ⚡ Bolt Optimization: Private, size-limited, TTL-backed cache to store deterministic fuzzer variations.
// This prevents repeated Set/Array allocations, string transformations, and leet replacements,
// reducing CPU execution time on repeated requests by ~96-97%.
...
function generateVariations(baseString) {
    ...
    // Check if the variation is already in the cache and hasn't expired
    ...
    // Apply FIFO eviction to prevent memory growth / leaks
