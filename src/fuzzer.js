...
// ⚡ Bolt Optimization: Private, size-limited, and TTL-backed cache for fuzzer variations.
// Since fuzzer generation is completely deterministic, caching fuzzed results prevents repeated
// string reversals, casing transformations, and array/Set allocations, boosting performance significantly.
...
module.exports = { generateVariations, fuzzerCache, MAX_CACHE_SIZE, CACHE_TTL };
