...
// ⚡ Bolt Optimization: Private, size-limited (MAX_CACHE_SIZE = 1000), TTL-backed (5 minutes) cache
// to store deterministic fuzzer variations and prevent repeated string/array/Set operations.
