...
const { app, isETagMatch, robotsETag, indexHtmlETag, robotsContent, indexHtmlContent, rareearthContent, rareearthETag, isolationContent, isolationETag } = require('../index');
